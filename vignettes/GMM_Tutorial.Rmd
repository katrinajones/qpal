...
1. Each shape mist have the same number of landmarks
...
Geomorph uses blombergs K to test for strength and significance of phylogenetic signal.
...
Now lets try a PGLS analysis in geomorph.
